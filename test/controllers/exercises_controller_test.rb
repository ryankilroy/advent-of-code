...
class ExercisesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create exercise" do
    assert_difference("Exercise.count") do
      post exercises_url, params: { exercise: { completed: @exercise.completed, day: @exercise.day, title: @exercise.title } }
    end
  ...
  test "should update exercise" do
    patch exercise_url(@exercise), params: { exercise: { completed: @exercise.completed, day: @exercise.day, title: @exercise.title } }
